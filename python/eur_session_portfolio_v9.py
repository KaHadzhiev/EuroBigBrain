#!/usr/bin/env python3
"""EUR M15 portfolio v9 — drop momentum_long_NY (3/8 WF folds), keep just the 2 SHORTS.

v9 = 2 NY-only short-bias strategies + vol_gate(5p)
"""
import sys, json
...
def main():
    ...
    print("\n[combine v9 — 2 shorts + vol_gate(5)]")

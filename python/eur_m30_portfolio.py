#!/usr/bin/env python3
"""EUR M30 portfolio (analogous to v9) — top 4 PF=1.4+ strategies, vol gate(5).

Strategies (from eur_m30_full sweep top-5):
  - ema_cross_short FullDay (PF 1.495)
  - breakout_range NY (PF 1.473)
  - fade_long NY (PF 1.441)
  - momentum_short London (PF 1.409)
"""
import sys, json
...
WINNERS = [
    {"name": "ema_cross_short_FullDay_M30", "entry_type": "ema_cross_short", "sess": "7-20",  "sl_atr": 0.3, "tp_atr": 3.0, "vt_vol": 2.0, "hold": 12},
    {"name": "breakout_range_NY_M30",       "entry_type": "breakout_range",  "sess": "13-20", "sl_atr": 0.3, "tp_atr": 3.0, "vt_vol": 2.0, "hold": 6},
    {"name": "fade_long_NY_M30",            "entry_type": "fade_long",       "sess": "13-20", "sl_atr": 0.3, "tp_atr": 3.0, "vt_vol": 1.2, "hold": 12},
    {"name": "momentum_short_London_M30",   "entry_type": "momentum_short",  "sess": "7-13",  "sl_atr": 0.3, "tp_atr": 3.0, "vt_vol": 2.0, "hold": 6},
]

GATE_PIPS = 5  # M30 ATR ~12-20p; gate=5 still meaningful

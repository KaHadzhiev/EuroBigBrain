...
STRATEGIES = [
    ...
    {"name": "EUR_M15_bb_squeeze_short_FullDay", "data": "eurusd_m15_2020_2026.parquet", "entry_type": "bb_squeeze_short", "sess": "7-20", "sl_atr": 0.5, "tp_atr": 3.0, "vt_vol": 1.5, "hold": 6},
    {"name": "EUR_M30_bb_squeeze_long_FullDay",  "data": "eurusd_m30_2020_2026.parquet", "entry_type": "bb_squeeze_long",  "sess": "7-20", "sl_atr": 0.5, "tp_atr": 3.0, "vt_vol": 2.0, "hold": 6},
]
GATE_PIPS = 5
DATA_CACHE = {}
...
def main():
    ...
    for w in STRATEGIES:
        ...
        print(f"  {w['name']:<33}{m.pf:>7.3f}{m.max_dd_pct:>7.1f}{m.recovery_factor:>8.2f}{m.sharpe_daily:>8.2f}{m.total_pnl:>+10.0f}{m.n_trades:>7}  (dpnl={delta_pnl:+.0f}, dPF={delta_pf:+.3f})")

    op = RESULTS / "eur_gbp_12strat_drop1.json"
